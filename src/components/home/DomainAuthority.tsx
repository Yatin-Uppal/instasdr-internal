  ...
  return (
    <React.Fragment>
      <div className="w-full max-w-container px-4   m-auto">
        <CommonSectionWithEmail color="#0075FF" img="/img/email.webp">
        ...
        <img src="/img/InstaSDR.webp" className="mt-16 hidden md:block" alt="InstaSDR"/>
        <img src="/img/instasdr1.webp" className="mt-16 md:hidden block" alt="InstaSDR1"/>
      </div>
    </React.Fragment>
  );
}
