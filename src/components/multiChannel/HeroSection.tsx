...
function HeroSection() {
  return (
    <React.Fragment>
      <div className="py-16 pb-0 pt-12 md:py-24  text-center">
        ...
        <div className="w-full max-w-container px-4 m-auto">
          <h1 className="text-3xl	md:text-[56px] md:leading-[70px] font-inter text-light mb-4">
            1-Click <span className="text-yellow">Multi-Channel AI SDR</span>
          </h1>
          ...
          <button
            type="button"
            className="font-inter cursor-pointer text-sm mt-7 text-black font-semibold py-3 px-8 rounded-lg1 border  border-yellow bg-yellow hover:bg-lightYellow"
          >
            Get Started
          </button>
